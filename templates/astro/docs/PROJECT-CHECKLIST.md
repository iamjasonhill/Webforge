...
- [ ] What is the tagline/value proposition?
- [ ] What are the primary brand colors (Hex codes)?
- [ ] Is the logo available in SVG format?
...
- [ ] www or non-www? (Pick one for canonical)
...
- [ ] Identify current CMS (WordPress, Webflow, etc.)
...
- [ ] Crawl site to get full URL list (e.g., `wget --spider -r https://site.com`
      or online tool)
- [ ] Convert posts to Markdown/MDX (use automated tools for >20 posts)
